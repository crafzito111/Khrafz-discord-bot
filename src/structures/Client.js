...
GatewayIntentBits.GuildEmojisAndStickers,
    ...
    async loadCommands(){
        console.log(`(${process.env.PREFIX}) Cargando Commandos`.yellow);
        ...
        console.log(`(${process.env.PREFIX}) ${this.commands.size} Commandos Cargados`.green);

    }


    async loadSlashCommands(){
        console.log(`(/) Cargando Commandos`.yellow);
        ...
        console.log(`(/) ${this.slashCommands.size} Commandos Cargados`.green);
